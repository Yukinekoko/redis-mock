 ...
 * @date 2021/8/26
 */
public class SUNIONSTOREExecutor extends AbstractSetExecutor {

    @Override
    public Slice execute(List<Slice> params, RedisBase base, Socket socket) throws BaseException, IOException {
        Utils.checkArgumentsNumberGreater(params, 1);

        Set<Slice> mainSet = getSet(base, params.get(1));
        ...
        setSet(base, params.get(0), mainSet);
        return Response.integer(response.size());
    }
}
